...
export const GameDefinitions: MessageFns<GameDefinitions> = {
  ...
  fromJSON(object: any): GameDefinitions {
    return {
      ...
      gameModes: isObject(object.gameModes)
        ? Object.entries(object.gameModes).reduce<{ [key: string]: GameMode }>((acc, [key, value]) => {
          acc[key] = GameMode.fromJSON(value);
          return acc;
        }, {})
        : {},
  ...
  fromPartial<I extends Exact<DeepPartial<GameDefinitions>, I>>(object: I): GameDefinitions {
    ...
    message.gameModes = Object.entries(object.gameModes ?? {}).reduce<{ [key: string]: GameMode }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = GameMode.fromPartial(value);
        }
        return acc;
      },
      {},
