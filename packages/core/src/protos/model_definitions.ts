...
export const ModelDefinition: MessageFns<ModelDefinition> = {
  ...
  fromJSON(object: any): ModelDefinition {
    return {
      ...
      turret_origin: isSet(object.turret_origin) ? Vector3.fromJSON(object.turret_origin) : undefined,
      ...
      tracks: isObject(object.tracks)
        ...
        : {},
      bounding_box: isSet(object.bounding_box) ? BoundingBox.fromJSON(object.bounding_box) : undefined,
    };
  },
...
export const TurretModelDefinition: MessageFns<TurretModelDefinition> = {
  ...
  fromJSON(object: any): TurretModelDefinition {
    return {
      ...
      gun_origin: isSet(object.gun_origin) ? Vector3.fromJSON(object.gun_origin) : undefined,
