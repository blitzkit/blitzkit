...
export interface TankDefinition {
  ...
  camouflage_on_fire: number;
  equipment_preset: string;
  weight: number;
  dev_name: string;
  equalizer?: TankEqualizer | undefined;
}
...
export interface TankEqualizer {
...
export const TankDefinitions: MessageFns<TankDefinitions> = {
  encode(message: TankDefinitions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.tanks).forEach(([key, value]: [string, TankDefinition]) => {
  ...
  fromJSON(object: any): TankDefinitions {
    return {
      tanks: isObject(object.tanks)
        ? (globalThis.Object.entries(object.tanks) as [string, any][]).reduce(
          (acc: { [key: number]: TankDefinition }, [key, value]: [string, any]) => {
  ...
  toJSON(message: TankDefinitions): unknown {
    const obj: any = {};
    if (message.tanks) {
      const entries = globalThis.Object.entries(message.tanks) as [string, TankDefinition][];
      if (entries.length > 0) {
        obj.tanks = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<TankDefinitions>, I>>(object: I): TankDefinitions {
    const message = createBaseTankDefinitions();
    message.tanks = (globalThis.Object.entries(object.tanks ?? {}) as [string, TankDefinition][]).reduce(
      (acc: { [key: number]: TankDefinition }, [key, value]: [string, TankDefinition]) => {
        if (value !== undefined) {
...
export const TankDefinition: MessageFns<TankDefinition> = {
  encode(message: TankDefinition, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.roles).forEach(([key, value]: [string, number]) => {
    ...
    if (message.camouflage_on_fire !== 0) {
      writer.uint32(237).float(message.camouflage_on_fire);
    }
    ...
    if (message.equalizer !== undefined) {
      TankEqualizer.encode(message.equalizer, writer.uint32(266).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 29: {
          ...
          message.camouflage_on_fire = reader.float();
          continue;
        }
        case 30: {
          if (tag !== 242) {
        ...
        case 33: {
          ...
          message.equalizer = TankEqualizer.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TankDefinition {
    return {
      ...
      roles: isObject(object.roles)
        ...
        : {},
      fixed_camouflage: isSet(object.fixedCamouflage)
        ? globalThis.Boolean(object.fixedCamouflage)
        : isSet(object.fixed_camouflage)
      ...
      max_consumables: isSet(object.maxConsumables)
        ? globalThis.Number(object.maxConsumables)
        : isSet(object.max_consumables)
        ? globalThis.Number(object.max_consumables)
        : 0,
      max_provisions: isSet(object.maxProvisions)
        ? globalThis.Number(object.maxProvisions)
        : isSet(object.max_provisions)
      ...
      research_cost: isSet(object.researchCost)
        ? ResearchCost.fromJSON(object.researchCost)
        : isSet(object.research_cost)
        ? ResearchCost.fromJSON(object.research_cost)
        : undefined,
      speed_forwards: isSet(object.speedForwards)
        ? globalThis.Number(object.speedForwards)
        : isSet(object.speed_forwards)
        ? globalThis.Number(object.speed_forwards)
        : 0,
      speed_backwards: isSet(object.speedBackwards)
        ? globalThis.Number(object.speedBackwards)
        : isSet(object.speed_backwards)
        ? globalThis.Number(object.speed_backwards)
        : 0,
      camouflage_still: isSet(object.camouflageStill)
        ? globalThis.Number(object.camouflageStill)
        : isSet(object.camouflage_still)
        ? globalThis.Number(object.camouflage_still)
        : 0,
      camouflage_moving: isSet(object.camouflageMoving)
        ? globalThis.Number(object.camouflageMoving)
        : isSet(object.camouflage_moving)
        ? globalThis.Number(object.camouflage_moving)
        : 0,
      camouflage_on_fire: isSet(object.camouflageOnFire)
        ? globalThis.Number(object.camouflageOnFire)
        : isSet(object.camouflage_on_fire)
        ? globalThis.Number(object.camouflage_on_fire)
        : 0,
      equipment_preset: isSet(object.equipmentPreset)
        ? globalThis.String(object.equipmentPreset)
        : isSet(object.equipment_preset)
      ...
      dev_name: isSet(object.devName)
        ...
        : "",
      equalizer: isSet(object.equalizer) ? TankEqualizer.fromJSON(object.equalizer) : undefined,
    };
  },
  ...
  toJSON(message: TankDefinition): unknown {
    ...
    if (message.roles) {
      const entries = globalThis.Object.entries(message.roles) as [string, number][];
      if (entries.length > 0) {
        obj.roles = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.fixed_camouflage !== false) {
      obj.fixedCamouflage = message.fixed_camouflage;
    }
    ...
    if (message.max_consumables !== 0) {
      obj.maxConsumables = Math.round(message.max_consumables);
    }
    if (message.max_provisions !== 0) {
      obj.maxProvisions = Math.round(message.max_provisions);
    }
    if (message.tier !== 0) {
    ...
    if (message.research_cost !== undefined) {
      obj.researchCost = ResearchCost.toJSON(message.research_cost);
    }
    if (message.speed_forwards !== 0) {
      obj.speedForwards = message.speed_forwards;
    }
    if (message.speed_backwards !== 0) {
      obj.speedBackwards = message.speed_backwards;
    }
    if (message.camouflage_still !== 0) {
      obj.camouflageStill = message.camouflage_still;
    }
    if (message.camouflage_moving !== 0) {
      obj.camouflageMoving = message.camouflage_moving;
    }
    if (message.camouflage_on_fire !== 0) {
      obj.camouflageOnFire = message.camouflage_on_fire;
    }
    if (message.equipment_preset !== "") {
      obj.equipmentPreset = message.equipment_preset;
    }
    if (message.weight !== 0) {
    ...
    if (message.equalizer !== undefined) {
      obj.equalizer = TankEqualizer.toJSON(message.equalizer);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TankDefinition>, I>>(object: I): TankDefinition {
    ...
    message.roles = (globalThis.Object.entries(object.roles ?? {}) as [string, number][]).reduce(
    ...
    message.camouflage_on_fire = object.camouflage_on_fire ?? 0;
    ...
    message.equalizer = (object.equalizer !== undefined && object.equalizer !== null)
      ? TankEqualizer.fromPartial(object.equalizer)
      : undefined;
    return message;
  },
};
...
export const ResearchCost: MessageFns<ResearchCost> = {
  ...
  fromJSON(object: any): ResearchCost {
    return {
      research_cost_type: isSet(object.xp)
        ...
        : isSet(object.seasonalTokens)
        ? { $case: "seasonal_tokens", value: ResearchCostSeasonalTokens.fromJSON(object.seasonalTokens) }
  ...
  toJSON(message: ResearchCost): unknown {
    ...
    } else if (message.research_cost_type?.$case === "seasonal_tokens") {
      obj.seasonalTokens = ResearchCostSeasonalTokens.toJSON(message.research_cost_type.value);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ResearchCost>, I>>(object: I): ResearchCost {
    const message = createBaseResearchCost();
    switch (object.research_cost_type?.$case) {
      case "xp": {
        if (object.research_cost_type?.value !== undefined && object.research_cost_type?.value !== null) {
...
export const TrackDefinition: MessageFns<TrackDefinition> = {
  ...
  fromJSON(object: any): TrackDefinition {
    return {
      ...
      name: isSet(object.name) ? I18nString.fromJSON(object.name) : undefined,
      weight: isSet(object.weight) ? globalThis.Number(object.weight) : 0,
      traverse_speed: isSet(object.traverseSpeed)
        ? globalThis.Number(object.traverseSpeed)
        : isSet(object.traverse_speed)
      ...
      research_cost: isSet(object.researchCost)
        ...
        ? ResearchCost.fromJSON(object.research_cost)
        : undefined,
      dispersion_move: isSet(object.dispersionMove)
        ? globalThis.Number(object.dispersionMove)
        : isSet(object.dispersion_move)
        ? globalThis.Number(object.dispersion_move)
        : 0,
      dispersion_traverse: isSet(object.dispersionTraverse)
        ? globalThis.Number(object.dispersionTraverse)
        : isSet(object.dispersion_traverse)
        ? globalThis.Number(object.dispersion_traverse)
        : 0,
      resistance_hard: isSet(object.resistanceHard)
        ? globalThis.Number(object.resistanceHard)
        : isSet(object.resistance_hard)
        ? globalThis.Number(object.resistance_hard)
        : 0,
      resistance_medium: isSet(object.resistanceMedium)
        ? globalThis.Number(object.resistanceMedium)
        : isSet(object.resistance_medium)
        ? globalThis.Number(object.resistance_medium)
        : 0,
      resistance_soft: isSet(object.resistanceSoft)
        ? globalThis.Number(object.resistanceSoft)
        : isSet(object.resistance_soft)
  ...
  toJSON(message: TrackDefinition): unknown {
    ...
    if (message.traverse_speed !== 0) {
      obj.traverseSpeed = message.traverse_speed;
    }
    if (message.research_cost !== undefined) {
      obj.researchCost = ResearchCost.toJSON(message.research_cost);
    }
    if (message.dispersion_move !== 0) {
      obj.dispersionMove = message.dispersion_move;
    }
    if (message.dispersion_traverse !== 0) {
      obj.dispersionTraverse = message.dispersion_traverse;
    }
    if (message.resistance_hard !== 0) {
      obj.resistanceHard = message.resistance_hard;
    }
    if (message.resistance_medium !== 0) {
      obj.resistanceMedium = message.resistance_medium;
    }
    if (message.resistance_soft !== 0) {
      obj.resistanceSoft = message.resistance_soft;
    }
...
export const EngineDefinition: MessageFns<EngineDefinition> = {
  ...
  fromJSON(object: any): EngineDefinition {
    return {
      ...
      research_cost: isSet(object.researchCost)
        ...
        : undefined,
      tier: isSet(object.tier) ? globalThis.Number(object.tier) : 0,
      fire_chance: isSet(object.fireChance)
        ? globalThis.Number(object.fireChance)
        : isSet(object.fire_chance)
  ...
  toJSON(message: EngineDefinition): unknown {
    ...
    if (message.fire_chance !== 0) {
      obj.fireChance = message.fire_chance;
    }
    if (message.power !== 0) {
...
export const TurretDefinition: MessageFns<TurretDefinition> = {
  ...
  fromJSON(object: any): TurretDefinition {
    return {
      id: isSet(object.id) ? globalThis.Number(object.id) : 0,
      health: isSet(object.health) ? globalThis.Number(object.health) : 0,
      view_range: isSet(object.viewRange)
        ? globalThis.Number(object.viewRange)
        : isSet(object.view_range)
  ...
  toJSON(message: TurretDefinition): unknown {
    ...
    if (message.view_range !== 0) {
      obj.viewRange = Math.round(message.view_range);
    }
    if (message.traverse_speed !== 0) {
      obj.traverseSpeed = message.traverse_speed;
    }
...
export const GunDefinition: MessageFns<GunDefinition> = {
  encode(message: GunDefinition, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.assault_ranges !== undefined) {
      AssaultRanges.encode(message.assault_ranges, writer.uint32(154).fork()).join();
    }
  ...
  fromJSON(object: any): GunDefinition {
    return {
      gun_type: isSet(object.regular)
        ...
        : isSet(object.autoLoader)
        ? { $case: "auto_loader", value: GunDefinitionAutoLoader.fromJSON(object.autoLoader) }
        : isSet(object.auto_loader)
        ? { $case: "auto_loader", value: GunDefinitionAutoLoader.fromJSON(object.auto_loader) }
        : isSet(object.autoReloader)
        ? { $case: "auto_reloader", value: GunDefinitionAutoReloader.fromJSON(object.autoReloader) }
        : isSet(object.auto_reloader)
        ? { $case: "auto_reloader", value: GunDefinitionAutoReloader.fromJSON(object.auto_reloader) }
        : undefined,
      id: isSet(object.id) ? globalThis.Number(object.id) : 0,
      rotation_speed: isSet(object.rotationSpeed)
        ? globalThis.Number(object.rotationSpeed)
        : isSet(object.rotation_speed)
      ...
      shells: globalThis.Array.isArray(object?.shells)
        ...
        : [],
      camouflage_loss: isSet(object.camouflageLoss)
        ? globalThis.Number(object.camouflageLoss)
        : isSet(object.camouflage_loss)
        ? globalThis.Number(object.camouflage_loss)
        : 0,
      aim_time: isSet(object.aimTime)
        ? globalThis.Number(object.aimTime)
        : isSet(object.aim_time)
        ? globalThis.Number(object.aim_time)
        : 0,
      dispersion_base: isSet(object.dispersionBase)
        ? globalThis.Number(object.dispersionBase)
        : isSet(object.dispersion_base)
      ...
      dispersion_traverse: isSet(object.dispersionTraverse)
        ...
        ? globalThis.Number(object.dispersion_traverse)
        : 0,
      dispersion_shot: isSet(object.dispersionShot)
        ? globalThis.Number(object.dispersionShot)
        : isSet(object.dispersion_shot)
        ? globalThis.Number(object.dispersion_shot)
        : 0,
      dispersion_damaged: isSet(object.dispersionDamaged)
        ? globalThis.Number(object.dispersionDamaged)
        : isSet(object.dispersion_damaged)
        ? globalThis.Number(object.dispersion_damaged)
        : 0,
      unlocks: globalThis.Array.isArray(object?.unlocks)
        ? object.unlocks.map((e: any) => Unlock.fromJSON(e))
        : [],
      shell_capacity: isSet(object.shellCapacity)
        ? globalThis.Number(object.shellCapacity)
        : isSet(object.shell_capacity)
        ? globalThis.Number(object.shell_capacity)
        : 0,
      assault_ranges: isSet(object.assaultRanges)
        ? AssaultRanges.fromJSON(object.assaultRanges)
        : isSet(object.assault_ranges)
  ...
  toJSON(message: GunDefinition): unknown {
    ...
    } else if (message.gun_type?.$case === "auto_loader") {
      obj.autoLoader = GunDefinitionAutoLoader.toJSON(message.gun_type.value);
    } else if (message.gun_type?.$case === "auto_reloader") {
      obj.autoReloader = GunDefinitionAutoReloader.toJSON(message.gun_type.value);
    }
    if (message.id !== 0) {
      obj.id = Math.round(message.id);
    }
    if (message.rotation_speed !== 0) {
      obj.rotationSpeed = message.rotation_speed;
    }
    if (message.research_cost !== undefined) {
      obj.researchCost = ResearchCost.toJSON(message.research_cost);
    }
    ...
    if (message.camouflage_loss !== 0) {
      obj.camouflageLoss = message.camouflage_loss;
    }
    if (message.aim_time !== 0) {
      obj.aimTime = message.aim_time;
    }
    if (message.dispersion_base !== 0) {
      obj.dispersionBase = message.dispersion_base;
    }
    if (message.dispersion_traverse !== 0) {
      obj.dispersionTraverse = message.dispersion_traverse;
    }
    if (message.dispersion_shot !== 0) {
      obj.dispersionShot = message.dispersion_shot;
    }
    if (message.dispersion_damaged !== 0) {
      obj.dispersionDamaged = message.dispersion_damaged;
    }
    if (message.unlocks?.length) {
      obj.unlocks = message.unlocks.map((e) => Unlock.toJSON(e));
    }
    if (message.shell_capacity !== 0) {
      obj.shellCapacity = Math.round(message.shell_capacity);
    }
    if (message.assault_ranges !== undefined) {
      obj.assaultRanges = AssaultRanges.toJSON(message.assault_ranges);
    }
    if (message.burst !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<GunDefinition>, I>>(object: I): GunDefinition {
    const message = createBaseGunDefinition();
    switch (object.gun_type?.$case) {
      case "regular": {
        if (object.gun_type?.value !== undefined && object.gun_type?.value !== null) {
    ...
    message.assault_ranges = (object.assault_ranges !== undefined && object.assault_ranges !== null)
      ...
      : undefined;
    message.burst = (object.burst !== undefined && object.burst !== null) ? Burst.fromPartial(object.burst) : undefined;
    return message;
  },
};
...
export const GunDefinitionAutoLoader: MessageFns<GunDefinitionAutoLoader> = {
  ...
  fromJSON(object: any): GunDefinitionAutoLoader {
    return {
      clip_reload: isSet(object.clipReload)
        ? globalThis.Number(object.clipReload)
        : isSet(object.clip_reload)
        ? globalThis.Number(object.clip_reload)
        : 0,
      intra_clip: isSet(object.intraClip)
        ? globalThis.Number(object.intraClip)
        : isSet(object.intra_clip)
        ? globalThis.Number(object.intra_clip)
        : 0,
      shell_count: isSet(object.shellCount)
        ? globalThis.Number(object.shellCount)
  ...
  toJSON(message: GunDefinitionAutoLoader): unknown {
    const obj: any = {};
    if (message.clip_reload !== 0) {
      obj.clipReload = message.clip_reload;
    }
    if (message.intra_clip !== 0) {
      obj.intraClip = message.intra_clip;
    }
    if (message.shell_count !== 0) {
      obj.shellCount = message.shell_count;
    }
    return obj;
  },
...
export const Burst: MessageFns<Burst> = {
  encode(message: Burst, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.count !== 0) {
...
export const GunDefinitionAutoReloader: MessageFns<GunDefinitionAutoReloader> = {
  ...
  fromJSON(object: any): GunDefinitionAutoReloader {
    return {
      shell_reloads: globalThis.Array.isArray(object?.shellReloads)
        ? object.shellReloads.map((e: any) => globalThis.Number(e))
        : globalThis.Array.isArray(object?.shell_reloads)
  ...
  toJSON(message: GunDefinitionAutoReloader): unknown {
    ...
    if (message.shell_reloads?.length) {
      obj.shellReloads = message.shell_reloads;
    }
    if (message.intra_clip !== 0) {
      obj.intraClip = message.intra_clip;
    }
...
export const AssaultRanges: MessageFns<AssaultRanges> = {
  ...
  fromJSON(object: any): AssaultRanges {
    return {
      ...
      types: globalThis.Array.isArray(object?.types) ? object.types.map((e: any) => shellTypeFromJSON(e)) : [],
    };
  },
...
export const ShellDefinition: MessageFns<ShellDefinition> = {
  ...
  fromJSON(object: any): ShellDefinition {
    return {
      ...
      armor_damage: isSet(object.armorDamage)
        ? globalThis.Number(object.armorDamage)
        : isSet(object.armor_damage)
        ? globalThis.Number(object.armor_damage)
        : 0,
      module_damage: isSet(object.moduleDamage)
        ? globalThis.Number(object.moduleDamage)
        : isSet(object.module_damage)
      ...
      explosion_radius: isSet(object.explosionRadius)
        ? globalThis.Number(object.explosionRadius)
        : isSet(object.explosion_radius)
  ...
  toJSON(message: ShellDefinition): unknown {
    ...
    if (message.armor_damage !== 0) {
      obj.armorDamage = Math.round(message.armor_damage);
    }
    if (message.module_damage !== 0) {
      obj.moduleDamage = Math.round(message.module_damage);
    }
    if (message.caliber !== 0) {
    ...
    if (message.explosion_radius !== undefined && message.explosion_radius !== 0) {
      obj.explosionRadius = message.explosion_radius;
    }
    if (message.range !== 0) {
...
function createBaseTankEqualizer(): TankEqualizer {
  return { max_health_factor: 0, piercing_power_factor: 0, module_health_factor: 0, damage_factor: 0, armor_factor: 0 };
}

export const TankEqualizer: MessageFns<TankEqualizer> = {
  encode(message: TankEqualizer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.max_health_factor !== 0) {
      writer.uint32(13).float(message.max_health_factor);
    }
    if (message.piercing_power_factor !== 0) {
      writer.uint32(21).float(message.piercing_power_factor);
    }
    if (message.module_health_factor !== 0) {
      writer.uint32(29).float(message.module_health_factor);
    }
    if (message.damage_factor !== 0) {
      writer.uint32(37).float(message.damage_factor);
    }
    if (message.armor_factor !== 0) {
      writer.uint32(45).float(message.armor_factor);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TankEqualizer {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTankEqualizer();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.max_health_factor = reader.float();
          continue;
        }
        case 2: {
          if (tag !== 21) {
          ...
          message.piercing_power_factor = reader.float();
          continue;
        }
        case 3: {
          if (tag !== 29) {
          ...
          message.module_health_factor = reader.float();
          continue;
        }
        case 4: {
          if (tag !== 37) {
          ...
          message.damage_factor = reader.float();
          continue;
        }
        case 5: {
          if (tag !== 45) {
          ...
          message.armor_factor = reader.float();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TankEqualizer {
    return {
      max_health_factor: isSet(object.maxHealthFactor)
        ? globalThis.Number(object.maxHealthFactor)
        : isSet(object.max_health_factor)
        ? globalThis.Number(object.max_health_factor)
        : 0,
      piercing_power_factor: isSet(object.piercingPowerFactor)
        ? globalThis.Number(object.piercingPowerFactor)
        : isSet(object.piercing_power_factor)
        ? globalThis.Number(object.piercing_power_factor)
        : 0,
      module_health_factor: isSet(object.moduleHealthFactor)
        ? globalThis.Number(object.moduleHealthFactor)
        : isSet(object.module_health_factor)
        ? globalThis.Number(object.module_health_factor)
        : 0,
      damage_factor: isSet(object.damageFactor)
        ? globalThis.Number(object.damageFactor)
        : isSet(object.damage_factor)
        ? globalThis.Number(object.damage_factor)
        : 0,
      armor_factor: isSet(object.armorFactor)
        ? globalThis.Number(object.armorFactor)
        : isSet(object.armor_factor)
        ? globalThis.Number(object.armor_factor)
        : 0,
    };
  },

  toJSON(message: TankEqualizer): unknown {
    const obj: any = {};
    if (message.max_health_factor !== 0) {
      obj.maxHealthFactor = message.max_health_factor;
    }
    if (message.piercing_power_factor !== 0) {
      obj.piercingPowerFactor = message.piercing_power_factor;
    }
    if (message.module_health_factor !== 0) {
      obj.moduleHealthFactor = message.module_health_factor;
    }
    if (message.damage_factor !== 0) {
      obj.damageFactor = message.damage_factor;
    }
    if (message.armor_factor !== 0) {
      obj.armorFactor = message.armor_factor;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<TankEqualizer>, I>>(base?: I): TankEqualizer {
    return TankEqualizer.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TankEqualizer>, I>>(object: I): TankEqualizer {
    const message = createBaseTankEqualizer();
    message.max_health_factor = object.max_health_factor ?? 0;
    message.piercing_power_factor = object.piercing_power_factor ?? 0;
    message.module_health_factor = object.module_health_factor ?? 0;
    message.damage_factor = object.damage_factor ?? 0;
    message.armor_factor = object.armor_factor ?? 0;
    return message;
  },
};
