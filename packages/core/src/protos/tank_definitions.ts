...
export const TankDefinition: MessageFns<TankDefinition> = {
  ...
  fromJSON(object: any): TankDefinition {
    return {
      ...
      roles: isObject(object.roles)
        ? Object.entries(object.roles).reduce<{ [key: string]: number }>((acc, [key, value]) => {
      ...
      camouflage_on_fire: isSet(object.camouflage_on_fire) ? globalThis.Number(object.camouflage_on_fire) : 0,
  ...
  toJSON(message: TankDefinition): unknown {
    ...
    if (message.camouflage_on_fire !== 0) {
      obj.camouflage_on_fire = message.camouflage_on_fire;
    }
    if (message.equipment_preset !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<TankDefinition>, I>>(object: I): TankDefinition {
    ...
    message.roles = Object.entries(object.roles ?? {}).reduce<{ [key: string]: number }>((acc, [key, value]) => {
      if (value !== undefined) {
...
export const Equalizer: MessageFns<Equalizer> = {
  ...
  fromJSON(object: any): Equalizer {
    return {
      ...
      module_health: isSet(object.module_health) ? globalThis.Number(object.module_health) : 0,
  ...
  toJSON(message: Equalizer): unknown {
    ...
    if (message.module_health !== 0) {
      obj.module_health = message.module_health;
    }
    if (message.damage !== 0) {
