...
//   protoc               v7.34.1
// source: camouflage_definitions.proto
...
export const CamouflageDefinitions: MessageFns<CamouflageDefinitions> = {
  encode(message: CamouflageDefinitions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.camouflages).forEach(([key, value]: [string, Camouflage]) => {
  ...
  fromJSON(object: any): CamouflageDefinitions {
    return {
      camouflages: isObject(object.camouflages)
        ? (globalThis.Object.entries(object.camouflages) as [string, any][]).reduce(
          (acc: { [key: number]: Camouflage }, [key, value]: [string, any]) => {
  ...
  toJSON(message: CamouflageDefinitions): unknown {
    ...
    if (message.camouflages) {
      const entries = globalThis.Object.entries(message.camouflages) as [string, Camouflage][];
      if (entries.length > 0) {
        obj.camouflages = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<CamouflageDefinitions>, I>>(object: I): CamouflageDefinitions {
    const message = createBaseCamouflageDefinitions();
    message.camouflages = (globalThis.Object.entries(object.camouflages ?? {}) as [string, Camouflage][]).reduce(
      (acc: { [key: number]: Camouflage }, [key, value]: [string, Camouflage]) => {
        if (value !== undefined) {
...
export const CamouflageDefinitions_CamouflagesEntry: MessageFns<CamouflageDefinitions_CamouflagesEntry> = {
  ...
  fromJSON(object: any): CamouflageDefinitions_CamouflagesEntry {
    return {
      ...
      value: isSet(object.value) ? Camouflage.fromJSON(object.value) : undefined,
    };
  },
...
export const Camouflage: MessageFns<Camouflage> = {
  ...
  fromJSON(object: any): Camouflage {
    return {
      ...
      tank_name: isSet(object.tankName)
        ? I18nString.fromJSON(object.tankName)
        : isSet(object.tank_name)
        ? I18nString.fromJSON(object.tank_name)
        : undefined,
      tank_name_full: isSet(object.tankNameFull)
        ? I18nString.fromJSON(object.tankNameFull)
        : isSet(object.tank_name_full)
  ...
  toJSON(message: Camouflage): unknown {
    ...
    if (message.tank_name !== undefined) {
      obj.tankName = I18nString.toJSON(message.tank_name);
    }
    if (message.tank_name_full !== undefined) {
      obj.tankNameFull = I18nString.toJSON(message.tank_name_full);
    }
    return obj;
  },
