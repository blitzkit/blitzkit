              ...
              {developerMode && (
                <>
                  <Text mt="2" color="gray" size="2">
                    <b>DEV:</b>{" "}
                    <Code variant="soft" highContrast color="gray">
                      {highlightArmor.name}
                    </Code>
                  </Text>
                </>
                      ...
                      if (event.key === "Enter") {
                        ...
                        Tankopedia.mutate((draft) => {
                          ...
                          if (highlightArmor.name.startsWith("hull_")) {
                            ...
                            highlightArmor.name.startsWith("turret_")
                          ) {
                            ...
                            highlightArmor.name.startsWith("chassis_")
                          ) {
                  ...
                  <IconButton
                    ...
                    onClick={() => {
                      Tankopedia.mutate((draft) => {
                        ...
                        const gun = turret.guns[protagonist.gun.id];
                        const initialGun =
                          initialTurret.guns[protagonist.gun.id];
                        const track = tank.tracks[protagonist.track.id];
                        const initialTrack =
